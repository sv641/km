...
```
wget
https://raw.githubusercontent.com/kontainapp/km-releases/latest/kontain-install.sh -O - -q | bash
```
...
```
wget https://raw.githubusercontent.com/kontainapp/km-releases/v0.1-beta2-demo/kontain-install.sh -q
